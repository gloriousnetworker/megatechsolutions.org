            ...
            <Card key={cert.id} className="border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-white">
              ...
              <CardContent className="space-y-4">
                <div className="text-center">
                  ...
                  <p className="font-mono font-bold text-lg">{cert.id}</p>
                </div>
                
                <div className="text-center">
                  <p className="text-sm text-gray-600">Issued on</p>
                  <p className="font-medium">{new Date(cert.issued_at).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
                </div>
