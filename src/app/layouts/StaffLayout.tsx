...
export default function StaffLayout() {
  ...
  const navigation = [
    ...
    { name: "Student Management", href: "/staff/students", icon: Users },
        ...
        <aside className={`fixed lg:sticky top-0 left-0 z-40 h-screen bg-white border-r w-64 transform transition-transform lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
          <div className="flex flex-col h-full">
            <div className="hidden lg:flex items-center gap-3 px-6 py-6 border-b">
              ...
              <div>
                <div className="font-bold text-gray-900">Staff Portal</div>
            ...
            <div className="border-t p-4">
              <div className="flex items-center gap-3 mb-3 px-2">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-medium text-gray-900 text-sm truncate">Staff Member</div>
                  <div className="text-xs text-gray-600 truncate">{localStorage.getItem("userEmail")}</div>
                </div>
              </div>
